...
**`quarkdown doctor env`** reports the status of the external runtimes Quarkdown depends on: the JVM, and the Chrome browser required for [PDF export](pdf-export.md).
